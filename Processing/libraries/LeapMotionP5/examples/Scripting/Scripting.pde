...
// http://docs.oracle.com/javase/6/docs/technotes/guides/scripting/programmer_guide/
  // QUick check to see if this actualy works
...
void onFrame(com.leapmotion.leap.Controller controller) {
  ...
  // This actually works. How can we get it to send OSC? Or otherwise interact with the main code?
  try {
    engine.eval("println(\"This is hello from test.js, with avgPos  = \" + avgPos  );");
  } catch( ScriptException e) {
    println("Scripting error: " + e );
  }
